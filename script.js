...
////change font color
function changeCr(selectTag) {
  var listValue = selectTag.options[selectTag.selectedIndex].text;
  document.getElementById("text").style.color = listValue;
}
...
/////the hidden invert!!! 
function invert(){
  document.getElementById("wedBG").style.filter="invert(100%)";
  alert("Enjoy your Gothic Wedding !!");
  }
...
alert("Sorry, this was not designed for handheld devices, you can try in landscape mode if you like.");
}